...
use App\Presentation\Http\Controllers\BlueprintOpenApiController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::get('/blueprint/openapi', BlueprintOpenApiController::class)->name('api.v1.blueprint.openapi');
